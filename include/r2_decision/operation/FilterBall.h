...
{
class FilterBall : public BT::StatefulActionNode
{
public:
    FilterBall(const std::string& name,const BT::NodeConfiguration& config)
    : BT::StatefulActionNode(name,config)
    {
        ...
        sub_stm32 = nh.subscribe(receive_stm32_topic,100,&FilterBall::doSTM32,this);
    ...
    static BT::PortsList providedPorts()
    {
        ...
        ports_list.insert(BT::InputPort<int>("goalA"));
        return ports_list;
    }
...
private:
    ...
    void doSTM32(const r2_msgs::stm32 flag)
    {
        ...
        _if_no_need_filter = flag.ball_state;
    }
};
}