...
{
class TakeBall : public BT::StatefulActionNode
{
public:
    TakeBall(const std::string& name,const BT::NodeConfiguration& config)
    : BT::StatefulActionNode(name,config)
    {
        ...
        sub_stm32 = nh.subscribe(receive_stm32_topic,100,&TakeBall::doSTM32,this);
